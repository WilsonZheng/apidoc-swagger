...
//		 7. add required to sub object
//		 8. add type: object to each response definition
//		 9. fix post success response should return code 204
//		 10. fix when the URL parameter is required but show as path parameter
